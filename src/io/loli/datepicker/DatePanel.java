...
public class DatePanel extends JPanel {
	...
	public DatePanel(final Picker picker) {
		...
		yearTextField.setHorizontalAlignment(JButton.CENTER);
		monthTextField.setHorizontalAlignment(JButton.CENTER);
	...
	private void addMonth(int i) {
		...
		// date = cal.getTime();
		// selectDayLabel.setText("选中时间为： "+String.valueOf(cal.get(Calendar.MONTH)
		// + 1));
	...
	private JLabel[] getDayHeadLabels() {
		// return new JLabel[] { new JLabel("SUN"), new JLabel("MON"), new
		// JLabel("TUE"), new JLabel("WED"),
		// new JLabel("THU"), new JLabel("FRI"), new JLabel("SAT") };

		return new JLabel[] { new JLabel("星期日"), new JLabel("星期一"),
				new JLabel("星期二"), new JLabel("星期三"), new JLabel("星期四"),
				new JLabel("星期五"), new JLabel("星期六") };
	}
